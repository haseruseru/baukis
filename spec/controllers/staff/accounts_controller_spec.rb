...
describe Staff::AccountsController do
  ...
  before do
    ...
    example 'email属性を変更する' do
      ...
      patch :update,use_route: :staff , id: staff_member.id, staff_member: params_hash
      staff_member.reload
    ...
    example '例外ActionController::ParameterMissingが発生' do
      bypass_rescue
      expect { patch :update,use_route: :staff,id: staff_member.id}.to raise_error(ActionController::ParameterMissing)
    end
